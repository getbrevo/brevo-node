...
*/
export class UpdateEmailCampaignEmailExpirationDate {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "unit",
            "baseName": "unit",
            "type": "UpdateEmailCampaignEmailExpirationDate.UnitEnum"
        }    ];

    static getAttributeTypeMap() {
        return UpdateEmailCampaignEmailExpirationDate.attributeTypeMap;
    }
}

export namespace UpdateEmailCampaignEmailExpirationDate {
