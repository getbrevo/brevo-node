...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubAccountDetailsResponsePlanInfo', function () {
      beforeEach(function () {
        instance = new BrevoNode.SubAccountDetailsResponsePlanInfo();
      });

      it('should create an instance of SubAccountDetailsResponsePlanInfo', function () {
        // TODO: update the code to test SubAccountDetailsResponsePlanInfo
        expect(instance).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfo);
      });
