...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateUpdateContactModel', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateUpdateContactModel();
      });

      it('should create an instance of CreateUpdateContactModel', function () {
        // TODO: update the code to test CreateUpdateContactModel
        expect(instance).to.be.a(BrevoNode.CreateUpdateContactModel);
      });
