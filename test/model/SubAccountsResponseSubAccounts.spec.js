...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubAccountsResponseSubAccounts', function () {
      beforeEach(function () {
        instance = new BrevoNode.SubAccountsResponseSubAccounts();
      });

      it('should create an instance of SubAccountsResponseSubAccounts', function () {
        // TODO: update the code to test SubAccountsResponseSubAccounts
        expect(instance).to.be.a(BrevoNode.SubAccountsResponseSubAccounts);
      });
