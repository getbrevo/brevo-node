...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateSubAccount', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateSubAccount();
      });

      it('should create an instance of CreateSubAccount', function () {
        // TODO: update the code to test CreateSubAccount
        expect(instance).to.be.a(BrevoNode.CreateSubAccount);
      });
