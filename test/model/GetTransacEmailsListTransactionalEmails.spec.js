...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacEmailsListTransactionalEmails', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacEmailsListTransactionalEmails();
      });

      it('should create an instance of GetTransacEmailsListTransactionalEmails', function () {
        // TODO: update the code to test GetTransacEmailsListTransactionalEmails
        expect(instance).to.be.a(BrevoNode.GetTransacEmailsListTransactionalEmails);
      });
