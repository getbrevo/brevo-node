...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('TaskReminder', function () {
      beforeEach(function () {
        instance = new BrevoNode.TaskReminder();
      });

      it('should create an instance of TaskReminder', function () {
        // TODO: update the code to test TaskReminder
        expect(instance).to.be.a(BrevoNode.TaskReminder);
      });
