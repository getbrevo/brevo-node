...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacAggregatedSmsReport', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacAggregatedSmsReport();
      });

      it('should create an instance of GetTransacAggregatedSmsReport', function () {
        // TODO: update the code to test GetTransacAggregatedSmsReport
        expect(instance).to.be.a(BrevoNode.GetTransacAggregatedSmsReport);
      });
