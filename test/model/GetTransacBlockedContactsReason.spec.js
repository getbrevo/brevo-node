...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacBlockedContactsReason', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacBlockedContactsReason();
      });

      it('should create an instance of GetTransacBlockedContactsReason', function () {
        // TODO: update the code to test GetTransacBlockedContactsReason
        expect(instance).to.be.a(BrevoNode.GetTransacBlockedContactsReason);
      });
