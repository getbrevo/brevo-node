...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AbTestVersionClicksInner', function () {
      beforeEach(function () {
        instance = new BrevoNode.AbTestVersionClicksInner();
      });

      it('should create an instance of AbTestVersionClicksInner', function () {
        // TODO: update the code to test AbTestVersionClicksInner
        expect(instance).to.be.a(BrevoNode.AbTestVersionClicksInner);
      });
      ...
      it('should have the property clicksCount (base name: "clicksCount")', function () {
        // TODO: update the code to test the property clicksCount
        expect(instance).to.have.property('clicksCount');
        // expect(instance.clicksCount).to.be(expectedValueLiteral);
      });
