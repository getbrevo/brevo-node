...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetCategoryDetails', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetCategoryDetails();
      });

      it('should create an instance of GetCategoryDetails', function () {
        // TODO: update the code to test GetCategoryDetails
        expect(instance).to.be.a(BrevoNode.GetCategoryDetails);
      });
