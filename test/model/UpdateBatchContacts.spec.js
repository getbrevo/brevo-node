...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateBatchContacts', function () {
      beforeEach(function () {
        instance = new BrevoNode.UpdateBatchContacts();
      });

      it('should create an instance of UpdateBatchContacts', function () {
        // TODO: update the code to test UpdateBatchContacts
        expect(instance).to.be.a(BrevoNode.UpdateBatchContacts);
      });
