...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetProductDetails', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetProductDetails();
      });

      it('should create an instance of GetProductDetails', function () {
        // TODO: update the code to test GetProductDetails
        expect(instance).to.be.a(BrevoNode.GetProductDetails);
      });
      ...
      it('should have the property s3Original (base name: "s3Original")', function () {
        // TODO: update the code to test the property s3Original
        expect(instance).to.have.property('s3Original');
        // expect(instance.s3Original).to.be(expectedValueLiteral);
      });

      it('should have the property s3ThumbAnalytics (base name: "s3ThumbAnalytics")', function () {
        // TODO: update the code to test the property s3ThumbAnalytics
        expect(instance).to.have.property('s3ThumbAnalytics');
        // expect(instance.s3ThumbAnalytics).to.be(expectedValueLiteral);
      });

      it('should have the property metaInfo (base name: "metaInfo")', function () {
        // TODO: update the code to test the property metaInfo
        expect(instance).to.have.property('metaInfo');
        // expect(instance.metaInfo).to.be(expectedValueLiteral);
      });

      it('should have the property s3ThumbEditor (base name: "s3ThumbEditor")', function () {
        // TODO: update the code to test the property s3ThumbEditor
        expect(instance).to.have.property('s3ThumbEditor');
        // expect(instance.s3ThumbEditor).to.be(expectedValueLiteral);
      });
