...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetails', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetails();
      });

      it('should create an instance of GetExtendedContactDetails', function () {
        // TODO: update the code to test GetExtendedContactDetails
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetails);
      });
