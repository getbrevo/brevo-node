...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateWhatsAppTemplate', function() {
      ...
      it('should have the property bodyText (base name: "bodyText")', function() {
        // TODO: update the code to test the property bodyText
        expect(instance).to.have.property('bodyText');
        // expect(instance.bodyText).to.be(expectedValueLiteral);
      });

      it('should have the property headerText (base name: "headerText")', function() {
        // TODO: update the code to test the property headerText
        expect(instance).to.have.property('headerText');
        // expect(instance.headerText).to.be(expectedValueLiteral);
      });
