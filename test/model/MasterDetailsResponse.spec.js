...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MasterDetailsResponse', function () {
      beforeEach(function () {
        instance = new BrevoNode.MasterDetailsResponse();
      });

      it('should create an instance of MasterDetailsResponse', function () {
        // TODO: update the code to test MasterDetailsResponse
        expect(instance).to.be.a(BrevoNode.MasterDetailsResponse);
      });
