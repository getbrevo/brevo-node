...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreatedBatchId', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreatedBatchId();
      });

      it('should create an instance of CreatedBatchId', function () {
        // TODO: update the code to test CreatedBatchId
        expect(instance).to.be.a(BrevoNode.CreatedBatchId);
      });
