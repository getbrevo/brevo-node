...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetSmtpTemplateOverviewSender', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetSmtpTemplateOverviewSender();
      });

      it('should create an instance of GetSmtpTemplateOverviewSender', function () {
        // TODO: update the code to test GetSmtpTemplateOverviewSender
        expect(instance).to.be.a(BrevoNode.GetSmtpTemplateOverviewSender);
      });
