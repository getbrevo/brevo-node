...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetDomainsList', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetDomainsList();
      });

      it('should create an instance of GetDomainsList', function () {
        // TODO: update the code to test GetDomainsList
        expect(instance).to.be.a(BrevoNode.GetDomainsList);
      });
