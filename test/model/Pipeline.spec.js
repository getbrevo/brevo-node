...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Pipeline', function() {
      beforeEach(function() {
        instance = new Brevo.Pipeline();
      });

      it('should create an instance of Pipeline', function() {
        // TODO: update the code to test Pipeline
        expect(instance).to.be.a(Brevo.Pipeline);
      });
      ...
      it('should have the property pipelineName (base name: "pipeline_name")', function() {
        // TODO: update the code to test the property pipelineName
        expect(instance).to.have.property('pipelineName');
        // expect(instance.pipelineName).to.be(expectedValueLiteral);
      });
