...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateExternalFeed', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateExternalFeed();
      });

      it('should create an instance of CreateExternalFeed', function () {
        // TODO: update the code to test CreateExternalFeed
        expect(instance).to.be.a(BrevoNode.CreateExternalFeed);
      });
