...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetInboundEmailEvents', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetInboundEmailEvents();
      });

      it('should create an instance of GetInboundEmailEvents', function () {
        // TODO: update the code to test GetInboundEmailEvents
        expect(instance).to.be.a(BrevoNode.GetInboundEmailEvents);
      });
