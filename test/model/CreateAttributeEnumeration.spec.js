...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateAttributeEnumeration', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateAttributeEnumeration();
      });

      it('should create an instance of CreateAttributeEnumeration', function () {
        // TODO: update the code to test CreateAttributeEnumeration
        expect(instance).to.be.a(BrevoNode.CreateAttributeEnumeration);
      });
