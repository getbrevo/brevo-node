...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CompaniesList', function () {
      beforeEach(function () {
        instance = new BrevoNode.CompaniesList();
      });

      it('should create an instance of CompaniesList', function () {
        // TODO: update the code to test CompaniesList
        expect(instance).to.be.a(BrevoNode.CompaniesList);
      });
