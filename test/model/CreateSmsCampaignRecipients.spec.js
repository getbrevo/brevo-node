...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateSmsCampaignRecipients', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateSmsCampaignRecipients();
      });

      it('should create an instance of CreateSmsCampaignRecipients', function () {
        // TODO: update the code to test CreateSmsCampaignRecipients
        expect(instance).to.be.a(BrevoNode.CreateSmsCampaignRecipients);
      });
