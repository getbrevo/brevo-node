...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription();
      });

      it('should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription', function () {
        // TODO: update the code to test GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription);
      });
