...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription', function() {
      beforeEach(function() {
        instance = new Brevo.GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription();
      });
      ...
      it('should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription', function() {
        ...
        expect(instance).to.be.a(Brevo.GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription);
      });
