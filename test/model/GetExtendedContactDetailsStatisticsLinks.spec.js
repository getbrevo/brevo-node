...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsLinks', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetailsStatisticsLinks();
      });

      it('should create an instance of GetExtendedContactDetailsStatisticsLinks', function () {
        // TODO: update the code to test GetExtendedContactDetailsStatisticsLinks
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsLinks);
      });
