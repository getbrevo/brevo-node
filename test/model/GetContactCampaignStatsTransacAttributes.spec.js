...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetContactCampaignStatsTransacAttributes', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetContactCampaignStatsTransacAttributes();
      });

      it('should create an instance of GetContactCampaignStatsTransacAttributes', function () {
        // TODO: update the code to test GetContactCampaignStatsTransacAttributes
        expect(instance).to.be.a(BrevoNode.GetContactCampaignStatsTransacAttributes);
      });
