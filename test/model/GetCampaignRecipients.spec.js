...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetCampaignRecipients', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetCampaignRecipients();
      });

      it('should create an instance of GetCampaignRecipients', function () {
        // TODO: update the code to test GetCampaignRecipients
        expect(instance).to.be.a(BrevoNode.GetCampaignRecipients);
      });
      ...
      it('should have the property exclusionLists (base name: "exclusionLists")', function () {
        // TODO: update the code to test the property exclusionLists
        expect(instance).to.have.property('exclusionLists');
        // expect(instance.exclusionLists).to.be(expectedValueLiteral);
      });
