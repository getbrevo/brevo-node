...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateCoupons', function() {
      beforeEach(function() {
        instance = new Brevo.CreateCoupons();
      });

      it('should create an instance of CreateCoupons', function() {
        // TODO: update the code to test CreateCoupons
        expect(instance).to.be.a(Brevo.CreateCoupons);
      });
