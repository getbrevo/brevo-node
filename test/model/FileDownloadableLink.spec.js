...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('FileDownloadableLink', function () {
      beforeEach(function () {
        instance = new BrevoNode.FileDownloadableLink();
      });

      it('should create an instance of FileDownloadableLink', function () {
        // TODO: update the code to test FileDownloadableLink
        expect(instance).to.be.a(BrevoNode.FileDownloadableLink);
      });
