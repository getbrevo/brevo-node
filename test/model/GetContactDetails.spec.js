...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetContactDetails', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetContactDetails();
      });

      it('should create an instance of GetContactDetails', function () {
        // TODO: update the code to test GetContactDetails
        expect(instance).to.be.a(BrevoNode.GetContactDetails);
      });
      ...
      it('should have the property listUnsubscribed (base name: "listUnsubscribed")', function () {
        // TODO: update the code to test the property listUnsubscribed
        expect(instance).to.have.property('listUnsubscribed');
        // expect(instance.listUnsubscribed).to.be(expectedValueLiteral);
      });
