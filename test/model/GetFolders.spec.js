...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetFolders', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetFolders();
      });

      it('should create an instance of GetFolders', function () {
        // TODO: update the code to test GetFolders
        expect(instance).to.be.a(BrevoNode.GetFolders);
      });

      it('should have the property folders (base name: "folders")', function () {
        // TODO: update the code to test the property folders
        expect(instance).to.have.property('folders');
        // expect(instance.folders).to.be(expectedValueLiteral);
      });
