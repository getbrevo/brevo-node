...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateUpdateCategories', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateUpdateCategories();
      });

      it('should create an instance of CreateUpdateCategories', function () {
        // TODO: update the code to test CreateUpdateCategories
        expect(instance).to.be.a(BrevoNode.CreateUpdateCategories);
      });
