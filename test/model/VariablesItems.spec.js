...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('VariablesItems', function () {
      beforeEach(function () {
        instance = new BrevoNode.VariablesItems();
      });

      it('should create an instance of VariablesItems', function () {
        // TODO: update the code to test VariablesItems
        expect(instance).to.be.a(BrevoNode.VariablesItems);
      });
