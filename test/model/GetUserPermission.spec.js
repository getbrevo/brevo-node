...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetUserPermission', function() {
      beforeEach(function() {
        instance = new BrevoNode.GetUserPermission();
      });

      it('should create an instance of GetUserPermission', function() {
        // TODO: update the code to test GetUserPermission
        expect(instance).to.be.a(BrevoNode.GetUserPermission);
      });
