...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubAccountsResponse', function () {
      beforeEach(function () {
        instance = new BrevoNode.SubAccountsResponse();
      });

      it('should create an instance of SubAccountsResponse', function () {
        // TODO: update the code to test SubAccountsResponse
        expect(instance).to.be.a(BrevoNode.SubAccountsResponse);
      });
