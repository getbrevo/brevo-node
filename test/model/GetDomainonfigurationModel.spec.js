...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetDomainConfigurationModel', function () {
      ...
      it('should create an instance of GetDomainonfigurationModel', function () {
        // TODO: update the code to test GetDomainonfigurationModel
        // expect(instance).to.be.a(BrevoNode.GetDomainonfigurationModel);
      });
