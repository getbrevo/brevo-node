...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacBlockedContacts', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacBlockedContacts();
      });

      it('should create an instance of GetTransacBlockedContacts', function () {
        // TODO: update the code to test GetTransacBlockedContacts
        expect(instance).to.be.a(BrevoNode.GetTransacBlockedContacts);
      });
