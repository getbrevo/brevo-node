...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateSmtpTemplateSender', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateSmtpTemplateSender();
      });

      it('should create an instance of CreateSmtpTemplateSender', function () {
        // TODO: update the code to test CreateSmtpTemplateSender
        expect(instance).to.be.a(BrevoNode.CreateSmtpTemplateSender);
      });
