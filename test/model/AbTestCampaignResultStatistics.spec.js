...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AbTestCampaignResultStatistics', function () {
      beforeEach(function () {
        instance = new BrevoNode.AbTestCampaignResultStatistics();
      });

      it('should create an instance of AbTestCampaignResultStatistics', function () {
        // TODO: update the code to test AbTestCampaignResultStatistics
        expect(instance).to.be.a(BrevoNode.AbTestCampaignResultStatistics);
      });

      it('should have the property openers (base name: "openers")', function () {
        // TODO: update the code to test the property openers
        expect(instance).to.have.property('openers');
        // expect(instance.openers).to.be(expectedValueLiteral);
      });
