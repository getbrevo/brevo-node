...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetScheduledEmailByMessageId', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetScheduledEmailByMessageId();
      });

      it('should create an instance of GetScheduledEmailByMessageId', function () {
        // TODO: update the code to test GetScheduledEmailByMessageId
        expect(instance).to.be.a(BrevoNode.GetScheduledEmailByMessageId);
      });
