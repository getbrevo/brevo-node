...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubAccountDetailsResponsePlanInfoCredits', function () {
      beforeEach(function () {
        instance = new BrevoNode.SubAccountDetailsResponsePlanInfoCredits();
      });

      it('should create an instance of SubAccountDetailsResponsePlanInfoCredits', function () {
        // TODO: update the code to test SubAccountDetailsResponsePlanInfoCredits
        expect(instance).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoCredits);
      });
