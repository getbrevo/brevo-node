...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedListCampaignStats', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedListCampaignStats();
      });

      it('should create an instance of GetExtendedListCampaignStats', function () {
        // TODO: update the code to test GetExtendedListCampaignStats
        expect(instance).to.be.a(BrevoNode.GetExtendedListCampaignStats);
      });
