...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SubAccountUpdatePlanRequest', function () {
      beforeEach(function () {
        instance = new BrevoNode.SubAccountUpdatePlanRequest();
      });

      it('should create an instance of SubAccountUpdatePlanRequest', function () {
        // TODO: update the code to test SubAccountUpdatePlanRequest
        expect(instance).to.be.a(BrevoNode.SubAccountUpdatePlanRequest);
      });
