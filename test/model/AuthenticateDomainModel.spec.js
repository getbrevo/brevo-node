...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('AuthenticateDomainModel', function () {
      beforeEach(function () {
        instance = new BrevoNode.AuthenticateDomainModel();
      });

      it('should create an instance of AuthenticateDomainModel', function () {
        // TODO: update the code to test AuthenticateDomainModel
        expect(instance).to.be.a(BrevoNode.AuthenticateDomainModel);
      });
