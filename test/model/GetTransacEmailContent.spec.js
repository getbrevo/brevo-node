...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacEmailContent', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacEmailContent();
      });

      it('should create an instance of GetTransacEmailContent', function () {
        // TODO: update the code to test GetTransacEmailContent
        expect(instance).to.be.a(BrevoNode.GetTransacEmailContent);
      });
      ...
      it('should have the property attachmentCount (base name: "attachmentCount")', function () {
        // TODO: update the code to test the property attachmentCount
        expect(instance).to.have.property('attachmentCount');
        // expect(instance.attachmentCount).to.be(expectedValueLiteral);
      });
