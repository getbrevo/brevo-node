...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetAccountActivity', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetAccountActivity();
      });

      it('should create an instance of GetAccountActivity', function () {
        // TODO: update the code to test GetAccountActivity
        expect(instance).to.be.a(BrevoNode.GetAccountActivity);
      });
