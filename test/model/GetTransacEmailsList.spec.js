...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacEmailsList', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacEmailsList();
      });

      it('should create an instance of GetTransacEmailsList', function () {
        // TODO: update the code to test GetTransacEmailsList
        expect(instance).to.be.a(BrevoNode.GetTransacEmailsList);
      });
      ...
      it('should have the property transactionalEmails (base name: "transactionalEmails")', function () {
        // TODO: update the code to test the property transactionalEmails
        expect(instance).to.have.property('transactionalEmails');
        // expect(instance.transactionalEmails).to.be(expectedValueLiteral);
      });
