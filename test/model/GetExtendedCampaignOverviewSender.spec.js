...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedCampaignOverviewSender', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedCampaignOverviewSender();
      });

      it('should create an instance of GetExtendedCampaignOverviewSender', function () {
        // TODO: update the code to test GetExtendedCampaignOverviewSender
        expect(instance).to.be.a(BrevoNode.GetExtendedCampaignOverviewSender);
      });
