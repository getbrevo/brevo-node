...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateContact', function() {
      beforeEach(function() {
        instance = new Brevo.CreateContact();
      });

      it('should create an instance of CreateContact', function() {
        // TODO: update the code to test CreateContact
        expect(instance).to.be.a(Brevo.CreateContact);
      });
      ...
      it('should have the property extId (base name: "ext_id")', function() {
        // TODO: update the code to test the property extId
        expect(instance).to.have.property('extId');
        // expect(instance.extId).to.be(expectedValueLiteral);
      });
