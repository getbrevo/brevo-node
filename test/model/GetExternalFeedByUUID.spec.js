...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExternalFeedByUUID', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExternalFeedByUUID();
      });

      it('should create an instance of GetExternalFeedByUUID', function () {
        // TODO: update the code to test GetExternalFeedByUUID
        expect(instance).to.be.a(BrevoNode.GetExternalFeedByUUID);
      });
