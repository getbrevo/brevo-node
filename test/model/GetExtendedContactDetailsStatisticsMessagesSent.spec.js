...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsMessagesSent', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetailsStatisticsMessagesSent();
      });

      it('should create an instance of GetExtendedContactDetailsStatisticsMessagesSent', function () {
        // TODO: update the code to test GetExtendedContactDetailsStatisticsMessagesSent
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsMessagesSent);
      });
