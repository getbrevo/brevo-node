...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetTransacEmailContentEvents', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetTransacEmailContentEvents();
      });

      it('should create an instance of GetTransacEmailContentEvents', function () {
        // TODO: update the code to test GetTransacEmailContentEvents
        expect(instance).to.be.a(BrevoNode.GetTransacEmailContentEvents);
      });
