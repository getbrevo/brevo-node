...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsClicked', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetailsStatisticsClicked();
      });

      it('should create an instance of GetExtendedContactDetailsStatisticsClicked', function () {
        // TODO: update the code to test GetExtendedContactDetailsStatisticsClicked
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsClicked);
      });
