...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateWhatsAppCampaign', function() {
      beforeEach(function() {
        instance = new BrevoNode.UpdateWhatsAppCampaign();
      });

      it('should create an instance of UpdateWhatsAppCampaign', function() {
        // TODO: update the code to test UpdateWhatsAppCampaign
        expect(instance).to.be.a(BrevoNode.UpdateWhatsAppCampaign);
      });
      ...
      it('should have the property rescheduleFor (base name: "rescheduleFor")', function() {
        // TODO: update the code to test the property rescheduleFor
        expect(instance).to.have.property('rescheduleFor');
        // expect(instance.rescheduleFor).to.be(expectedValueLiteral);
      });
