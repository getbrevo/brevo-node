...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateWhatsAppCampaign', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateWhatsAppCampaign();
      });

      it('should create an instance of CreateWhatsAppCampaign', function () {
        // TODO: update the code to test CreateWhatsAppCampaign
        expect(instance).to.be.a(BrevoNode.CreateWhatsAppCampaign);
      });
