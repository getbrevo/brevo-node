...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateEmailCampaignSender', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateEmailCampaignSender();
      });

      it('should create an instance of CreateEmailCampaignSender', function () {
        // TODO: update the code to test CreateEmailCampaignSender
        expect(instance).to.be.a(BrevoNode.CreateEmailCampaignSender);
      });
