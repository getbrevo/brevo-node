...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetAccountRelayData', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetAccountRelayData();
      });

      it('should create an instance of GetAccountRelayData', function () {
        // TODO: update the code to test GetAccountRelayData
        expect(instance).to.be.a(BrevoNode.GetAccountRelayData);
      });
      ...
      it('should have the property relay (base name: "relay")', function () {
        // TODO: update the code to test the property relay
        expect(instance).to.have.property('relay');
        // expect(instance.relay).to.be(expectedValueLiteral);
      });
