...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetWhatsappCampaignOverview', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetWhatsappCampaignOverview();
      });

      it('should create an instance of GetWhatsappCampaignOverview', function () {
        // TODO: update the code to test GetWhatsappCampaignOverview
        expect(instance).to.be.a(BrevoNode.GetWhatsappCampaignOverview);
      });
