...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateAttributeEnumeration', function () {
      beforeEach(function () {
        instance = new BrevoNode.UpdateAttributeEnumeration();
      });

      it('should create an instance of UpdateAttributeEnumeration', function () {
        // TODO: update the code to test UpdateAttributeEnumeration
        expect(instance).to.be.a(BrevoNode.UpdateAttributeEnumeration);
      });
