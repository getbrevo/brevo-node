...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SendSmtpEmail', function () {
      beforeEach(function () {
        instance = new BrevoNode.SendSmtpEmail();
      });

      it('should create an instance of SendSmtpEmail', function () {
        // TODO: update the code to test SendSmtpEmail
        expect(instance).to.be.a(BrevoNode.SendSmtpEmail);
      });
      ...
      it('should have the property textContent (base name: "textContent")', function () {
        // TODO: update the code to test the property textContent
        expect(instance).to.have.property('textContent');
        // expect(instance.textContent).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property messageVersions (base name: "messageVersions")', function () {
        // TODO: update the code to test the property messageVersions
        expect(instance).to.have.property('messageVersions');
        // expect(instance.messageVersions).to.be(expectedValueLiteral);
      });
