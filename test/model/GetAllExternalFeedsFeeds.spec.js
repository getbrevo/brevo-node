...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetAllExternalFeedsFeeds', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetAllExternalFeedsFeeds();
      });

      it('should create an instance of GetAllExternalFeedsFeeds', function () {
        // TODO: update the code to test GetAllExternalFeedsFeeds
        expect(instance).to.be.a(BrevoNode.GetAllExternalFeedsFeeds);
      });
