...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateSmsCampaign', function() {
      beforeEach(function() {
        instance = new Brevo.CreateSmsCampaign();
      });

      it('should create an instance of CreateSmsCampaign', function() {
        // TODO: update the code to test CreateSmsCampaign
        expect(instance).to.be.a(Brevo.CreateSmsCampaign);
      });
      ...
      it('should have the property organisationPrefix (base name: "organisationPrefix")', function() {
        // TODO: update the code to test the property organisationPrefix
        expect(instance).to.have.property('organisationPrefix');
        // expect(instance.organisationPrefix).to.be(expectedValueLiteral);
      });

      it('should have the property unsubscribeInstruction (base name: "unsubscribeInstruction")', function() {
        // TODO: update the code to test the property unsubscribeInstruction
        expect(instance).to.have.property('unsubscribeInstruction');
        // expect(instance.unsubscribeInstruction).to.be(expectedValueLiteral);
      });
