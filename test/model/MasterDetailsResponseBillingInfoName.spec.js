...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('MasterDetailsResponseBillingInfoName', function () {
      beforeEach(function () {
        instance = new BrevoNode.MasterDetailsResponseBillingInfoName();
      });

      it('should create an instance of MasterDetailsResponseBillingInfoName', function () {
        // TODO: update the code to test MasterDetailsResponseBillingInfoName
        expect(instance).to.be.a(BrevoNode.MasterDetailsResponseBillingInfoName);
      });
