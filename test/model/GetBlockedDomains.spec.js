...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetBlockedDomains', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetBlockedDomains();
      });

      it('should create an instance of GetBlockedDomains', function () {
        // TODO: update the code to test GetBlockedDomains
        expect(instance).to.be.a(BrevoNode.GetBlockedDomains);
      });
