...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsDelivered', function () {
      // beforeEach(function () {
      //   instance = new BrevoNode.GetExtendedContactDetailsStatisticsDelivered();
      // });

      // it('should create an instance of GetExtendedContactDetailsStatisticsDelivered', function () {
      //   // TODO: update the code to test GetExtendedContactDetailsStatisticsDelivered
      //   expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsDelivered);
      // });
