...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetInboundEmailEventsByUuidAttachments', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetInboundEmailEventsByUuidAttachments();
      });

      it('should create an instance of GetInboundEmailEventsByUuidAttachments', function () {
        // TODO: update the code to test GetInboundEmailEventsByUuidAttachments
        expect(instance).to.be.a(BrevoNode.GetInboundEmailEventsByUuidAttachments);
      });
