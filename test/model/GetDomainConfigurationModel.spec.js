...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetDomainConfigurationModel', function() {
      beforeEach(function() {
        instance = new BrevoNode.GetDomainConfigurationModel();
      });

      it('should create an instance of GetDomainConfigurationModel', function() {
        // TODO: update the code to test GetDomainConfigurationModel
        expect(instance).to.be.a(BrevoNode.GetDomainConfigurationModel);
      });
      ...
      it('should have the property dnsRecords (base name: "dns_records")', function() {
        // TODO: update the code to test the property dnsRecords
        expect(instance).to.have.property('dnsRecords');
        // expect(instance.dnsRecords).to.be(expectedValueLiteral);
      });
