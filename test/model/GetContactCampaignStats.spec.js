...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetContactCampaignStats', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetContactCampaignStats();
      });

      it('should create an instance of GetContactCampaignStats', function () {
        // TODO: update the code to test GetContactCampaignStats
        expect(instance).to.be.a(BrevoNode.GetContactCampaignStats);
      });
