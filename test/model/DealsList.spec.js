...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('DealsList', function () {
      beforeEach(function () {
        instance = new BrevoNode.DealsList();
      });

      it('should create an instance of DealsList', function () {
        // TODO: update the code to test DealsList
        expect(instance).to.be.a(BrevoNode.DealsList);
      });
