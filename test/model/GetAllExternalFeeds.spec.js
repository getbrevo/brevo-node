...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetAllExternalFeeds', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetAllExternalFeeds();
      });

      it('should create an instance of GetAllExternalFeeds', function () {
        // TODO: update the code to test GetAllExternalFeeds
        expect(instance).to.be.a(BrevoNode.GetAllExternalFeeds);
      });
