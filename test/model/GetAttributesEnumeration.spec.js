...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetAttributesEnumeration', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetAttributesEnumeration();
      });

      it('should create an instance of GetAttributesEnumeration', function () {
        // TODO: update the code to test GetAttributesEnumeration
        expect(instance).to.be.a(BrevoNode.GetAttributesEnumeration);
      });
