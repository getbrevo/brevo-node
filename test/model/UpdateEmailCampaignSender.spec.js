...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateEmailCampaignSender', function () {
      beforeEach(function () {
        instance = new BrevoNode.UpdateEmailCampaignSender();
      });

      it('should create an instance of UpdateEmailCampaignSender', function () {
        // TODO: update the code to test UpdateEmailCampaignSender
        expect(instance).to.be.a(BrevoNode.UpdateEmailCampaignSender);
      });
