...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendTransacSms', function() {
      beforeEach(function() {
        instance = new Brevo.SendTransacSms();
      });

      it('should create an instance of SendTransacSms', function() {
        // TODO: update the code to test SendTransacSms
        expect(instance).to.be.a(Brevo.SendTransacSms);
      });
      ...
      it('should have the property webUrl (base name: "webUrl")', function() {
        // TODO: update the code to test the property webUrl
        expect(instance).to.have.property('webUrl');
        // expect(instance.webUrl).to.be(expectedValueLiteral);
      });
