...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetProducts', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetProducts();
      });

      it('should create an instance of GetProducts', function () {
        // TODO: update the code to test GetProducts
        expect(instance).to.be.a(BrevoNode.GetProducts);
      });
