...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetContactCampaignStatsOpened', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetContactCampaignStatsOpened();
      });

      it('should create an instance of GetContactCampaignStatsOpened', function () {
        // TODO: update the code to test GetContactCampaignStatsOpened
        expect(instance).to.be.a(BrevoNode.GetContactCampaignStatsOpened);
      });
