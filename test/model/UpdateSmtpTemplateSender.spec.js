...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('UpdateSmtpTemplateSender', function () {
      beforeEach(function () {
        instance = new BrevoNode.UpdateSmtpTemplateSender();
      });

      it('should create an instance of UpdateSmtpTemplateSender', function () {
        // TODO: update the code to test UpdateSmtpTemplateSender
        expect(instance).to.be.a(BrevoNode.UpdateSmtpTemplateSender);
      });
