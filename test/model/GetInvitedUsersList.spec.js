...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetInvitedUsersList', function() {
      beforeEach(function() {
        instance = new BrevoNode.GetInvitedUsersList();
      });

      it('should create an instance of GetInvitedUsersList', function() {
        // TODO: update the code to test GetInvitedUsersList
        expect(instance).to.be.a(BrevoNode.GetInvitedUsersList);
      });
