...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetInboundEmailEventsEvents', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetInboundEmailEventsEvents();
      });

      it('should create an instance of GetInboundEmailEventsEvents', function () {
        // TODO: update the code to test GetInboundEmailEventsEvents
        expect(instance).to.be.a(BrevoNode.GetInboundEmailEventsEvents);
      });
