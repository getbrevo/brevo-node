...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetSmsCampaignOverview', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetSmsCampaignOverview();
      });

      it('should create an instance of GetSmsCampaignOverview', function () {
        // TODO: update the code to test GetSmsCampaignOverview
        expect(instance).to.be.a(BrevoNode.GetSmsCampaignOverview);
      });
