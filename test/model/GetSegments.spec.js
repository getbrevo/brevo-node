...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetSegments', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetSegments();
      });

      it('should create an instance of GetSegments', function () {
        // TODO: update the code to test GetSegments
        expect(instance).to.be.a(BrevoNode.GetSegments);
      });
