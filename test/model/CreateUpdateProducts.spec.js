...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateUpdateProducts', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateUpdateProducts();
      });

      it('should create an instance of CreateUpdateProducts', function () {
        // TODO: update the code to test CreateUpdateProducts
        expect(instance).to.be.a(BrevoNode.CreateUpdateProducts);
      });
