...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('CreateUpdateProduct', function () {
      beforeEach(function () {
        instance = new BrevoNode.CreateUpdateProduct();
      });

      it('should create an instance of CreateUpdateProduct', function () {
        // TODO: update the code to test CreateUpdateProduct
        expect(instance).to.be.a(BrevoNode.CreateUpdateProduct);
      });
