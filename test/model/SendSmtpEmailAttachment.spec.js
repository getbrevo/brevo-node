...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('SendSmtpEmailAttachment', function () {
      beforeEach(function () {
        instance = new BrevoNode.SendSmtpEmailAttachment();
      });

      it('should create an instance of SendSmtpEmailAttachment', function () {
        // TODO: update the code to test SendSmtpEmailAttachment
        expect(instance).to.be.a(BrevoNode.SendSmtpEmailAttachment);
      });
