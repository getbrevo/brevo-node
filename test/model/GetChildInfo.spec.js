...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetChildInfo', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetChildInfo();
      });

      it('should create an instance of GetChildInfo', function () {
        // TODO: update the code to test GetChildInfo
        expect(instance).to.be.a(BrevoNode.GetChildInfo);
      });
      ...
      it('should have the property apiKeys (base name: "apiKeys")', function () {
        // TODO: update the code to test the property apiKeys
        expect(instance).to.have.property('apiKeys');
        // expect(instance.apiKeys).to.be(expectedValueLiteral);
      });
