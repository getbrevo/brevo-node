...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetAccountActivityLogs', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetAccountActivityLogs();
      });

      it('should create an instance of GetAccountActivityLogs', function () {
        // TODO: update the code to test GetAccountActivityLogs
        expect(instance).to.be.a(BrevoNode.GetAccountActivityLogs);
      });
