...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription();
      });

      it('should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription', function () {
        // TODO: update the code to test GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription);
      });
