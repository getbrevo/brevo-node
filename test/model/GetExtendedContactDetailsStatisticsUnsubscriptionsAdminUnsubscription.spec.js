...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription', function() {
      beforeEach(function() {
        instance = new Brevo.GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription();
      });
      ...
      it('should create an instance of GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription', function() {
        ...
        expect(instance).to.be.a(Brevo.GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription);
      });
