...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetStatsByDevice', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetStatsByDevice();
      });

      it('should create an instance of GetStatsByDevice', function () {
        // TODO: update the code to test GetStatsByDevice
        expect(instance).to.be.a(BrevoNode.GetStatsByDevice);
      });
      ...
      it('should have the property tablet (base name: "tablet")', function () {
        // TODO: update the code to test the property tablet
        expect(instance).to.have.property('tablet');
        // expect(instance.tablet).to.be(expectedValueLiteral);
      });
