...
(function (root, factory) {
  ...
  describe('(package)', function () {
    describe('GetExtendedContactDetailsStatisticsOpened', function () {
      beforeEach(function () {
        instance = new BrevoNode.GetExtendedContactDetailsStatisticsOpened();
      });

      it('should create an instance of GetExtendedContactDetailsStatisticsOpened', function () {
        // TODO: update the code to test GetExtendedContactDetailsStatisticsOpened
        expect(instance).to.be.a(BrevoNode.GetExtendedContactDetailsStatisticsOpened);
      });
