...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brevo.WebhooksApi();
  });
    ...
    describe('WebhooksApi', function() {
      describe('createWebhook', function() {
        it('should call createWebhook successfully', function(done) {
          ...
          /*
          var createWebhook = new Brevo.CreateWebhook();
      ...
      describe('exportWebhooksHistory', function() {
        it('should call exportWebhooksHistory successfully', function(done) {
          // TODO: uncomment, update parameter values for exportWebhooksHistory call and complete the assertions
          /*
          var exportWebhookHistory = new Brevo.ExportWebhooksHistory();
          exportWebhookHistory.days = 7;
          exportWebhookHistory.startDate = "2023-02-13";
          exportWebhookHistory.endDate = "2023-02-17";
          exportWebhookHistory.sort = "desc";
          exportWebhookHistory.event = "request";
          exportWebhookHistory.notifyURL = "https://brevo.com";
          exportWebhookHistory.webhookId = 2345;
          exportWebhookHistory.email = "example@brevo.com";
          exportWebhookHistory.messageId = <23befbae-1505-47a8-bd27-e30ef739f32c@fr.sib>;

          instance.exportWebhooksHistory(exportWebhookHistory).then(function(data) {
            // TODO: update response assertions
      ...
      describe('getWebhook', function() {
        it('should call getWebhook successfully', function(done) {
          ...
          instance.getWebhook(webhookId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetWebhook);
      ...
      describe('getWebhooks', function() {
        it('should call getWebhooks successfully', function(done) {
          ...
          instance.getWebhooks(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetWebhooks);
            {
      ...
      describe('updateWebhook', function() {
        it('should call updateWebhook successfully', function(done) {
          ...
          /*
          var webhookId = 789;
          var updateWebhook = new Brevo.UpdateWebhook();
