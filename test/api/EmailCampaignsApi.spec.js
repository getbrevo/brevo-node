...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new BrevoNode.EmailCampaignsApi();
  });
    ...
    describe('EmailCampaignsApi', function () {
      describe('createEmailCampaign', function () {
        it('should call createEmailCampaign successfully', function (done) {
          ...
          /*
          var emailCampaigns = new BrevoNode.CreateEmailCampaign();
          emailCampaigns.tag = "Newsletter";
          emailCampaigns.sender = new BrevoNode.CreateEmailCampaignSender();
          ...
          emailCampaigns.recipients = new BrevoNode.CreateEmailCampaignRecipients();
      ...
      describe('emailExportRecipients', function () {
        it('should call emailExportRecipients successfully', function (done) {
          ...
          var campaignId = 789;
          var opts = {};
          opts.recipientExport = new BrevoNode.EmailExportRecipients();
      ...
      describe('getAbTestCampaignResult', function () {
        it('should call getAbTestCampaignResult successfully', function (done) {
          ...
          instance.getAbTestCampaignResult(campaignId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.AbTestCampaignResult);
            ...
            expect(data.statistics).to.be.a(BrevoNode.AbTestCampaignResultStatistics);
                  expect(data.statistics.openers).to.be.a(BrevoNode.AbTestVersionStats);
              ...
              expect(data.statistics.clicks).to.be.a(BrevoNode.AbTestVersionStats);
              ...
              expect(data.statistics.unsubscribed).to.be.a(BrevoNode.AbTestVersionStats);
              ...
              expect(data.statistics.hardBounces).to.be.a(BrevoNode.AbTestVersionStats);
              ...
              expect(data.statistics.softBounces).to.be.a(BrevoNode.AbTestVersionStats);
              ...
              expect(data.statistics.complaints).to.be.a(BrevoNode.AbTestVersionStats);
            ...
            expect(data.clickedLinks).to.be.a(BrevoNode.AbTestCampaignResultClickedLinks);
                  expect(data.clickedLinks.versionA).to.be.a(BrevoNode.AbTestVersionClicks);
                  expect(data.clickedLinks.versionB).to.be.a(BrevoNode.AbTestVersionClicks);
      ...
      describe('getEmailCampaign', function () {
        it('should call getEmailCampaign successfully', function (done) {
          ...
          instance.getEmailCampaign(campaignId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetEmailCampaign);
            expect(data.id).to.be.a('number');
            ...
            expect(data.sender).to.be.a(BrevoNode.GetExtendedCampaignOverviewSender);
            ...
            expect(data.recipients).to.be.a(BrevoNode.GetSmsCampaignRecipients);
                expect(data.statistics).to.be.a(BrevoNode.GetSmsCampaignRecipients);
      ...
      describe('getEmailCampaigns', function () {
        it('should call getEmailCampaigns successfully', function (done) {
          ...
          instance.getEmailCampaigns(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetEmailCampaigns);
            {
      ...
      describe('getSharedTemplateUrl', function () {
        it('should call getSharedTemplateUrl successfully', function (done) {
          ...
          instance.getSharedTemplateUrl(campaignId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetSharedTemplateUrl);
      ...
      describe('sendReport', function () {
        it('should call sendReport successfully', function (done) {
          ...
          /*
          var campaignId = 789;
          var sendReport = new BrevoNode.SendReport();
          sendReport.language = "en";
          sendReport.email = new BrevoNode.SendReportEmail();
      ...
      describe('sendTestEmail', function () {
        it('should call sendTestEmail successfully', function (done) {
          ...
          /*
          var campaignId = 789;
          var emailTo = new BrevoNode.SendTestEmail();
      ...
      describe('updateCampaignStatus', function () {
        it('should call updateCampaignStatus successfully', function (done) {
          ...
          /*
          var campaignId = 789;
          var status = new BrevoNode.UpdateCampaignStatus();
      ...
      describe('updateEmailCampaign', function () {
        it('should call updateEmailCampaign successfully', function (done) {
          ...
          /*
          var campaignId = 789;
          var emailCampaign = new BrevoNode.UpdateEmailCampaign();
          emailCampaign.tag = "Newsletter";
          emailCampaign.sender = new BrevoNode.UpdateEmailCampaignSender();
          ...
          emailCampaign.recipients = new BrevoNode.UpdateEmailCampaignRecipients();
      ...
      describe('uploadImageToGallery', function () {
        it('should call uploadImageToGallery successfully', function (done) {
          ...
          /*
          var uploadImage = new BrevoNode.UploadImageToGallery();
          ...
          instance.uploadImageToGallery(uploadImage).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.UploadImageModel);
