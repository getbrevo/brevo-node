...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrevoNode.UserApi();
  });
      ...
      describe('getInvitedUsersList', function() {
        it('should call getInvitedUsersList successfully', function(done) {
          ...
          instance.getInvitedUsersList().then(function(data) {
            ...
            expect(data).to.be.a(BrevoNode.GetInvitedUsersList);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BrevoNode.GetInvitedUsersListUsers);
                ...
                expect(data.featureAccess).to.be.a(BrevoNode.GetInvitedUsersListFeatureAccess);
      ...
      describe('getUserPermission', function() {
        it('should call getUserPermission successfully', function(done) {
          ...
          instance.getUserPermission(email).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetUserPermission);
            expect(data.email).to.be.a('string');
            ...
            expect(data.status).to.be("active");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BrevoNode.GetUserPermissionPrivileges);
