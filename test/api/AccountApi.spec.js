...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new BrevoNode.AccountApi();
  });
      ...
      describe('getAccount', function () {
        it('should call getAccount successfully', function (done) {
          ...
          instance.getAccount().then(function(data) {
            ...
            expect(data).to.be.a(BrevoNode.GetAccount);
            ...
            expect(data.address).to.be.a(BrevoNode.GetExtendedClientAddress);
              ...
              expect(data.address.country).to.be("United States of America");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BrevoNode.GetAccountPlan);
            ...
            expect(data.relay).to.be.a(BrevoNode.GetAccountRelay);
                  expect(data.relay.enabled).to.be.a('boolean');
              expect(data.relay.enabled).to.be(true);
              expect(data.relay.data).to.be.a(BrevoNode.GetAccountRelayData);
            ...
            expect(data.marketingAutomation).to.be.a(BrevoNode.GetAccountMarketingAutomation);
