...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brevo.ContactsApi();
  });
    ...
    describe('ContactsApi', function() {
      describe('addContactToList', function() {
        it('should call addContactToList successfully', function(done) {
          ...
          instance.addContactToList(listId, contactEmails).then(function(data) {
            ...
            expect(data).to.be.a(Brevo.PostContactInfo);
            expect(data.contacts).to.be.a(Brevo.PostContactInfoContacts);
                  {
      ...
      describe('createAttribute', function() {
        it('should call createAttribute successfully', function(done) {
          ...
          var createAttribute = new Brevo.CreateAttribute();
          createAttribute.value = "COUNT[BLACKLISTED,BLACKLISTED,<,NOW()]";
          createAttribute.isRecurring = true;
          createAttribute.enumeration = [new Brevo.CreateAttributeEnumeration()];
      ...
      describe('createContact', function() {
        it('should call createContact successfully', function(done) {
          ...
          instance.createContact(createContact).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.CreateUpdateContactModel);
      ...
      describe('createDoiContact', function() {
        it('should call createDoiContact successfully', function(done) {
          ...
          /*
          var createDoiContact = new Brevo.CreateDoiContact();
      ...
      describe('createFolder', function() {
        it('should call createFolder successfully', function(done) {
          ...
          /*
          var createFolder = new Brevo.CreateUpdateFolder();
      ...
      describe('createList', function() {
        it('should call createList successfully', function(done) {
          ...
          /*
          var createList = new Brevo.CreateList();
      ...
      describe('getAttributes', function() {
        it('should call getAttributes successfully', function(done) {
          ...
          instance.getAttributes().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetAttributes);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Brevo.GetAttributesAttributes);
                ...
                expect(data.type).to.be("text");
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(Brevo.GetAttributesEnumeration);
      ...
      describe('getContactInfo', function() {
        it('should call getContactInfo successfully', function(done) {
          ...
          instance.getContactInfo(identifier, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetExtendedContactDetails);
            ...
            expect(data.statistics).to.be.a(Brevo.GetExtendedContactDetailsStatistics);
                  {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(Brevo.GetExtendedContactDetailsStatisticsMessagesSent);
              ...
              expect(data.statistics.unsubscriptions).to.be.a(Brevo.GetExtendedContactDetailsStatisticsUnsubscriptions);
                    {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(Brevo.GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription);
                    expect(data.campaignId).to.be.a('number');
                    expect(data.campaignId).to.be(3);
                    expect(data.eventTime).to.be.a('string');
                    expect(data.eventTime).to.be("2017-03-12T20:15:13Z");
                ...
                }
                {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(Brevo.GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription);
                    expect(data.eventTime).to.be.a('string');
                    expect(data.eventTime).to.be("2017-03-12T20:15:13Z");
                    expect(data.ip).to.be.a('string');
                    expect(data.ip).to.be("165.87.3.15");
                ...
                }
              {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(Brevo.GetExtendedContactDetailsStatisticsOpened);
                  expect(data.campaignId).to.be.a('number');
                  expect(data.campaignId).to.be(3);
              ...
              }
              {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(Brevo.GetExtendedContactDetailsStatisticsClicked);
                  expect(data.campaignId).to.be.a('number');
                  expect(data.campaignId).to.be(3);
                  {
                    ...
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                      expect(data).to.be.a(Brevo.GetExtendedContactDetailsStatisticsLinks);
                      expect(data.count).to.be.a('number');
                      expect(data.count).to.be(1);
                      expect(data.eventTime).to.be.a('string');
                      expect(data.eventTime).to.be("2017-03-12T20:15:13Z");
      ...
      describe('getContactStats', function() {
        it('should call getContactStats successfully', function(done) {
          ...
          instance.getContactStats(identifier, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetContactCampaignStats);
            {
            ...
            expect(data.unsubscriptions).to.be.a(Brevo.GetContactCampaignStatsUnsubscriptions);
                  {
              ...
              }
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Brevo.GetContactCampaignStatsOpened);
                expect(data.campaignId).to.be.a('number');
                expect(data.campaignId).to.be(3);
                expect(data.count).to.be.a('number');
            ...
            }
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Brevo.GetContactCampaignStatsClicked);
                expect(data.campaignId).to.be.a('number');
                expect(data.campaignId).to.be(3);
                {
                  let dataCtr = data.links;
            ...
            }
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Brevo.GetContactCampaignStatsTransacAttributes);
      ...
      describe('getContacts', function() {
        it('should call getContacts successfully', function(done) {
          ...
          opts.createdSince = "createdSince_example";
          opts.sort = "desc";

          instance.getContacts(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetContacts);
            {
      ...
      describe('getFolder', function() {
        it('should call getFolder successfully', function(done) {
          ...
          instance.getFolder(folderId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetFolder);
            expect(data.id).to.be.a('number');
      ...
      describe('getFolderLists', function() {
        it('should call getFolderLists successfully', function(done) {
          ...
          instance.getFolderLists(folderId, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetFolderLists);
            {
      ...
      describe('getFolders', function() {
        it('should call getFolders successfully', function(done) {
          ...
          instance.getFolders(limit, offset, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetFolders);
            {
      ...
      describe('getList', function() {
        it('should call getList successfully', function(done) {
          ...
          instance.getList(listId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetExtendedList);
            expect(data.id).to.be.a('number');
            ...
            expect(data.createdAt).to.be("2017-03-13T17:05:09Z");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Brevo.GetExtendedListCampaignStats);
                expect(data.campaignId).to.be.a('number');
                expect(data.campaignId).to.be(143);
                expect(data.stats).to.be.a(Brevo.GetCampaignStats);
      ...
      describe('getLists', function() {
        it('should call getLists successfully', function(done) {
          ...
          instance.getLists(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetLists);
            {
              let dataCtr = data.lists;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
      ...
      describe('getSegments', function() {
        it('should call getSegments successfully', function(done) {
          // TODO: uncomment, update parameter values for getSegments call and complete the assertions
          /*
          var limit = 10;
          var offset = 0;
          var opts = {};
          ...
          instance.getSegments(limit, offset, opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetSegments);
            expect(data.segments).to.be.a(Brevo.GetSegmentsSegments);
                  expect(data.segments.id).to.be.a('number');
              expect(data.segments.id).to.be(23);
              expect(data.segments.segmentName).to.be.a('string');
              expect(data.segments.segmentName).to.be("My Segment");
              expect(data.segments.categoryName).to.be.a('string');
              expect(data.segments.categoryName).to.be("New Category");
              expect(data.segments.updatedAt).to.be.a('string');
              expect(data.segments.updatedAt).to.be("2017-03-13T17:05:09Z");
            expect(data.count).to.be.a('number');
            expect(data.count).to.be(10);
      ...
      describe('importContacts', function() {
        it('should call importContacts successfully', function(done) {
          ...
          /*
          var requestContactImport = new Brevo.RequestContactImport();
...
Roger;Ellie;ellie36@example.com";
          ...
          requestContactImport.newList = new Brevo.RequestContactImportNewList();
      ...
      describe('removeContactFromList', function() {
        it('should call removeContactFromList successfully', function(done) {
          ...
          /*
          var listId = 789;
          var contactEmails = new Brevo.RemoveContactFromList();
      ...
      describe('requestContactExport', function() {
        it('should call requestContactExport successfully', function(done) {
          ...
          /*
          var requestContactExport = new Brevo.RequestContactExport();
          requestContactExport.exportAttributes = ["NAME"];
          requestContactExport.customContactFilter = new Brevo.RequestContactExportCustomContactFilter();
      ...
      describe('updateAttribute', function() {
        it('should call updateAttribute successfully', function(done) {
          ...
          var attributeCategory = "attributeCategory_example";
          var attributeName = "attributeName_example";
          var updateAttribute = new Brevo.UpdateAttribute();
          updateAttribute.value = "COUNT[BLACKLISTED,BLACKLISTED,<,NOW()]";
          updateAttribute.enumeration = [new Brevo.UpdateAttributeEnumeration()];
      ...
      describe('updateBatchContacts', function() {
        it('should call updateBatchContacts successfully', function(done) {
          ...
          /*
          var updateBatchContacts = new Brevo.UpdateBatchContacts();
          updateBatchContacts.contacts = [new Brevo.UpdateBatchContactsContacts()];
          ...
          updateBatchContacts.contacts[0].extId = "UpdateExternalId";
      ...
      describe('updateContact', function() {
        it('should call updateContact successfully', function(done) {
          ...
          updateContact.extId = "updateExternalId";
      ...
      describe('updateFolder', function() {
        it('should call updateFolder successfully', function(done) {
          ...
          /*
          var folderId = 789;
          var updateFolder = new Brevo.CreateUpdateFolder();
      ...
      describe('updateList', function() {
        it('should call updateList successfully', function(done) {
          ...
          /*
          var listId = 789;
          var updateList = new Brevo.UpdateList();
