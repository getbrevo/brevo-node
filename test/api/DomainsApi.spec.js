...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new BrevoNode.DomainsApi();
  });
    ...
    describe('DomainsApi', function () {
      describe('authenticateDomain', function () {
        it('should call authenticateDomain successfully', function (done) {
          ...
          instance.authenticateDomain(domainName).then(function(data) {
            ...
            expect(data).to.be.a(BrevoNode.AuthenticateDomainModel);
      ...
      describe('createDomain', function () {
        it('should call createDomain successfully', function (done) {
          ...
          /*
          var opts = {};
          opts.domainName = new BrevoNode.CreateDomain();
          opts.domainName.name = "mycompany.com";

          instance.createDomain(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.CreateDomainModel);
            ...
            expect(data.dnsRecords).to.be.a(BrevoNode.CreateDomainModelDnsRecords);
                  expect(data.dnsRecords.dkimRecord).to.be.a(BrevoNode.CreateDomainModelDnsRecordsDkimRecord);
              ...
              expect(data.dnsRecords.brevoCode).to.be.a(BrevoNode.CreateDomainModelDnsRecordsDkimRecord);
      ...
      describe('getDomainonfiguration', function () {
        it('should call getDomainonfiguration successfully', function (done) {
          // TODO: uncomment, update parameter values for getDomainonfiguration call and complete the assertions
          /*
          var domainName = "domainName_example";

          instance.getDomainonfiguration(domainName).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetDomainonfigurationModel);
      ...
      describe('getDomains', function () {
        it('should call getDomains successfully', function (done) {
          ...
          instance.getDomains().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetDomainsList);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BrevoNode.GetDomainsListDomains);
                expect(data.id).to.be.a('number');
