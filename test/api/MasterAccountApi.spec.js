...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new BrevoNode.MasterAccountApi();
  });
    ...
    describe('MasterAccountApi', function () {
      describe('corporateMasterAccountGet', function () {
        it('should call corporateMasterAccountGet successfully', function (done) {
          ...
          instance.corporateMasterAccountGet().then(function(data) {
            ...
            expect(data).to.be.a(BrevoNode.MasterDetailsResponse);
            ...
            expect(data.billingInfo).to.be.a(BrevoNode.MasterDetailsResponseBillingInfo);
              ...
              expect(data.billingInfo.name).to.be.a(BrevoNode.MasterDetailsResponseBillingInfoName);
              ...
              expect(data.billingInfo.address).to.be.a(BrevoNode.MasterDetailsResponseBillingInfoAddress);
            ...
            expect(data.planInfo).to.be.a(BrevoNode.MasterDetailsResponsePlanInfo);
              ...
              expect(data.planInfo.subAccounts).to.be(0);
              {
                ...
                for (let p in dataCtr) {
                  let data = dataCtr[p];
                  expect(data).to.be.a(BrevoNode.MasterDetailsResponsePlanInfoFeatures);
      ...
      describe('corporateSubAccountGet', function () {
        it('should call corporateSubAccountGet successfully', function (done) {
          ...
          instance.corporateSubAccountGet(offset, limit).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.SubAccountsResponse);
            ...
            expect(data.count).to.be(0);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(BrevoNode.SubAccountsResponseSubAccounts);
                expect(data.id).to.be.a('number');
                expect(data.id).to.be("0");
                expect(data.companyName).to.be.a('string');
                expect(data.companyName).to.be("");
      ...
      describe('corporateSubAccountIdGet', function () {
        it('should call corporateSubAccountIdGet successfully', function (done) {
          ...
          instance.corporateSubAccountIdGet(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.SubAccountDetailsResponse);
            expect(data.name).to.be.a('string');
            expect(data.name).to.be("");
            expect(data.email).to.be.a('string');
            expect(data.email).to.be("");
            expect(data.companyName).to.be.a('string');
            expect(data.companyName).to.be("");
            expect(data.planInfo).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfo);
                  expect(data.planInfo.credits).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoCredits);
                    expect(data.planInfo.credits.sms).to.be.a('number');
                expect(data.planInfo.credits.sms).to.be("0");
                expect(data.planInfo.credits.emails).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoCreditsEmails);
              ...
              expect(data.planInfo.features).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoFeatures);
                    expect(data.planInfo.features.inbox).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoFeaturesInbox);
                ...
                expect(data.planInfo.features.landingPage).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoFeaturesLandingPage);
                ...
                expect(data.planInfo.features.users).to.be.a(BrevoNode.SubAccountDetailsResponsePlanInfoFeaturesUsers);
      ...
      describe('corporateSubAccountIdPlanPut', function () {
        it('should call corporateSubAccountIdPlanPut successfully', function (done) {
          ...
          /*
          var id = 789;
          var updatePlanDetails = new BrevoNode.SubAccountUpdatePlanRequest();
          updatePlanDetails.credits = new BrevoNode.SubAccountUpdatePlanRequestCredits();
          updatePlanDetails.credits.email = "0";
          updatePlanDetails.features = new BrevoNode.SubAccountUpdatePlanRequestFeatures();
      ...
      describe('corporateSubAccountPost', function () {
        it('should call corporateSubAccountPost successfully', function (done) {
          ...
          /*
          var subAccountCreate = new BrevoNode.CreateSubAccount();
          ...
          instance.corporateSubAccountPost(subAccountCreate).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.CreateSubAccountResponse);
            expect(data.id).to.be.a('number');
      ...
      describe('corporateSubAccountSsoTokenPost', function () {
        it('should call corporateSubAccountSsoTokenPost successfully', function (done) {
          ...
          /*
          var ssoTokenRequest = new BrevoNode.SsoTokenRequest();
          ...
          instance.corporateSubAccountSsoTokenPost(ssoTokenRequest).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(BrevoNode.GetSsoToken);
