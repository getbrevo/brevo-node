...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Brevo.SMSCampaignsApi();
  });
    ...
    describe('SMSCampaignsApi', function() {
      describe('createSmsCampaign', function() {
        it('should call createSmsCampaign successfully', function(done) {
          ...
          /*
          var createSmsCampaign = new Brevo.CreateSmsCampaign();
          ...
          createSmsCampaign.recipients = new Brevo.CreateSmsCampaignRecipients();
          ...
          createSmsCampaign.organisationPrefix = "MyCompany";
          createSmsCampaign.unsubscribeInstruction = "send Stop if you want to unsubscribe.";
      ...
      describe('getSmsCampaign', function() {
        it('should call getSmsCampaign successfully', function(done) {
          ...
          instance.getSmsCampaign(campaignId).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetSmsCampaign);
            expect(data.id).to.be.a('number');
      ...
      describe('getSmsCampaigns', function() {
        it('should call getSmsCampaigns successfully', function(done) {
          ...
          instance.getSmsCampaigns(opts).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(Brevo.GetSmsCampaigns);
            {
      ...
      describe('requestSmsRecipientExport', function() {
        it('should call requestSmsRecipientExport successfully', function(done) {
          ...
          var campaignId = 789;
          var opts = {};
          opts.recipientExport = new Brevo.RequestSmsRecipientExport();
      ...
      describe('sendTestSms', function() {
        it('should call sendTestSms successfully', function(done) {
          ...
          /*
          var campaignId = 789;
          var phoneNumber = new Brevo.SendTestSms();
      ...
      describe('updateSmsCampaign', function() {
        it('should call updateSmsCampaign successfully', function(done) {
          ...
          /*
          var campaignId = 789;
          var updateSmsCampaign = new Brevo.UpdateSmsCampaign();
          ...
          updateSmsCampaign.recipients = new Brevo.CreateSmsCampaignRecipients();
          ...
          updateSmsCampaign.organisationPrefix = "MyCompany";
          updateSmsCampaign.unsubscribeInstruction = "send Stop if you want to unsubscribe.";
