...
(function(factory) {
   ...
   * <pre>
   * var BrevoNode = require('index'); // See note below*.
   * var xxxSvc = new BrevoNode.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new BrevoNode.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new BrevoNode.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new BrevoNode.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
