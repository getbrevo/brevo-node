...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function () {
     ...
     */
    this.basePath = 'https://api.brevo.com/v3'.replace(/\/+$/, '');
     ...
     */
    this.defaultHeaders = {
      'user-agent': `brevo_clientAPI/v${pkgJson.version}/node`
    };
  ...
  exports.setUserAgent = function (header) {
    if (typeof header == 'string' && header.substr(0, 11).trim().toLowerCase() === 'brevo_') {
