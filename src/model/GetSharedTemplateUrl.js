...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.GetSharedTemplateUrl = factory(root.BrevoNode.ApiClient);
  }
   ...
   * @class
   * @param sharedUrl {String} A unique URL for the email campaign or transactional template. This URL can be shared with other Brevo users.
   */
