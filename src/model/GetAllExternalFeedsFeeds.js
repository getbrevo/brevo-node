...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.GetAllExternalFeedsFeeds = factory(root.BrevoNode.ApiClient, root.BrevoNode.GetExternalFeedByUUIDHeaders);
  }
}(this, function(ApiClient, GetExternalFeedByUUIDHeaders) {
  'use strict';

  /**
   * The GetAllExternalFeedsFeeds model module.
   * @module model/GetAllExternalFeedsFeeds
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetAllExternalFeedsFeeds</code>.
   * @alias module:model/GetAllExternalFeedsFeeds
   * @class
   * @param id {String} ID of the feed
   * @param name {String} Name of the feed
   * @param url {String} URL of the feed
   * @param authType {module:model/GetAllExternalFeedsFeeds.AuthTypeEnum} Auth type of the feed: * `basic` * `token` * `noAuth` 
  ...
  /**
   * Constructs a <code>GetAllExternalFeedsFeeds</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllExternalFeedsFeeds} obj Optional instance to populate.
   * @return {module:model/GetAllExternalFeedsFeeds} The populated <code>GetAllExternalFeedsFeeds</code> instance.
   */
   ...
   * @member {module:model/GetAllExternalFeedsFeeds.AuthTypeEnum} authType
   */
