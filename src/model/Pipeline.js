...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Brevo.Pipeline = factory(root.Brevo.ApiClient, root.Brevo.PipelineStage);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pipeline_name'))
        obj.pipelineName = ApiClient.convertToType(data['pipeline_name'], 'String');
   ...
   */
  exports.prototype.pipelineName = undefined;
