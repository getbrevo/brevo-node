...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./SubAccountDetailsResponsePlanInfoFeaturesInbox'), require('./SubAccountDetailsResponsePlanInfoFeaturesLandingPage'), require('./SubAccountDetailsResponsePlanInfoFeaturesUsers'));
  } else {
    // Browser globals (root is window)
    if (!root.BrevoNode) {
      root.BrevoNode = {};
    }
    root.BrevoNode.SubAccountDetailsResponsePlanInfoFeatures = factory(root.BrevoNode.ApiClient, root.BrevoNode.SubAccountDetailsResponsePlanInfoFeaturesInbox, root.BrevoNode.SubAccountDetailsResponsePlanInfoFeaturesLandingPage, root.BrevoNode.SubAccountDetailsResponsePlanInfoFeaturesUsers);
  }
