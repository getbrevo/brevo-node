...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./SubAccountDetailsResponsePlanInfoCreditsEmails'));
  } else {
    // Browser globals (root is window)
    if (!root.BrevoNode) {
      root.BrevoNode = {};
    }
    root.BrevoNode.SubAccountDetailsResponsePlanInfoCredits = factory(root.BrevoNode.ApiClient, root.BrevoNode.SubAccountDetailsResponsePlanInfoCreditsEmails);
  }
