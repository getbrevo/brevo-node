...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.UpdateBatchContactsContacts = factory(root.BrevoNode.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ext_id'))
        obj.extId = ApiClient.convertToType(data['ext_id'], 'String');
   ...
   * @member {String} extId
   */
  exports.prototype.extId = undefined;
