...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.GetDomainonfigurationModel = factory(root.BrevoNode.ApiClient, root.BrevoNode.CreateDomainModelDnsRecords);
  }
}(this, function (ApiClient, CreateDomainModelDnsRecords) {
  'use strict';

  /**
   * The GetDomainonfigurationModel model module.
   * @module model/GetDomainonfigurationModel
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetDomainonfigurationModel</code>.
   * @alias module:model/GetDomainonfigurationModel
   * @class
  ...
  /**
   * Constructs a <code>GetDomainonfigurationModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetDomainonfigurationModel} obj Optional instance to populate.
   * @return {module:model/GetDomainonfigurationModel} The populated <code>GetDomainonfigurationModel</code> instance.
   */
