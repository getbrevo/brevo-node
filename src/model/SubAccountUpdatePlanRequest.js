...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./SubAccountUpdatePlanRequestCredits'), require('./SubAccountUpdatePlanRequestFeatures'));
  } else {
    // Browser globals (root is window)
    if (!root.BrevoNode) {
      root.BrevoNode = {};
    }
    root.BrevoNode.SubAccountUpdatePlanRequest = factory(root.BrevoNode.ApiClient, root.BrevoNode.SubAccountUpdatePlanRequestCredits, root.BrevoNode.SubAccountUpdatePlanRequestFeatures);
  }
