...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.CreateUpdateProduct = factory(root.BrevoNode.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreateUpdateProduct model module.
   * @module model/CreateUpdateProduct
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CreateUpdateProduct</code>.
   * @alias module:model/CreateUpdateProduct
   * @class
  ...
  /**
   * Constructs a <code>CreateUpdateProduct</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateUpdateProduct} obj Optional instance to populate.
   * @return {module:model/CreateUpdateProduct} The populated <code>CreateUpdateProduct</code> instance.
   */
