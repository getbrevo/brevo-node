...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.TransactionalEmailsApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.BlockDomain, root.BrevoNode.CreateModel, root.BrevoNode.CreateSmtpEmail, root.BrevoNode.CreateSmtpTemplate, root.BrevoNode.DeleteHardbounces, root.BrevoNode.ErrorModel, root.BrevoNode.GetAggregatedReport, root.BrevoNode.GetBlockedDomains, root.BrevoNode.GetEmailEventReport, root.BrevoNode.GetReports, root.BrevoNode.GetScheduledEmailByBatchId, root.BrevoNode.GetScheduledEmailByMessageId, root.BrevoNode.GetSmtpTemplateOverview, root.BrevoNode.GetSmtpTemplates, root.BrevoNode.GetTransacBlockedContacts, root.BrevoNode.GetTransacEmailContent, root.BrevoNode.GetTransacEmailsList, root.BrevoNode.PostSendFailed, root.BrevoNode.ScheduleSmtpEmail, root.BrevoNode.SendSmtpEmail, root.BrevoNode.SendTestEmail, root.BrevoNode.UpdateSmtpTemplate);
  }
