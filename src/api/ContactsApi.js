...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.ContactsApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.AddContactToList, root.BrevoNode.CreateAttribute, root.BrevoNode.CreateContact, root.BrevoNode.CreateDoiContact, root.BrevoNode.CreateList, root.BrevoNode.CreateModel, root.BrevoNode.CreateUpdateContactModel, root.BrevoNode.CreateUpdateFolder, root.BrevoNode.CreatedProcessId, root.BrevoNode.ErrorModel, root.BrevoNode.GetAttributes, root.BrevoNode.GetContactCampaignStats, root.BrevoNode.GetContacts, root.BrevoNode.GetExtendedContactDetails, root.BrevoNode.GetExtendedList, root.BrevoNode.GetFolder, root.BrevoNode.GetFolderLists, root.BrevoNode.GetFolders, root.BrevoNode.GetLists, root.BrevoNode.GetSegments, root.BrevoNode.PostContactInfo, root.BrevoNode.RemoveContactFromList, root.BrevoNode.RequestContactExport, root.BrevoNode.RequestContactImport, root.BrevoNode.UpdateAttribute, root.BrevoNode.UpdateBatchContacts, root.BrevoNode.UpdateContact, root.BrevoNode.UpdateList);
  }
