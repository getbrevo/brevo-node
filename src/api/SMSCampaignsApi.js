...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.SMSCampaignsApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.CreateModel, root.BrevoNode.CreateSmsCampaign, root.BrevoNode.CreatedProcessId, root.BrevoNode.ErrorModel, root.BrevoNode.GetSmsCampaign, root.BrevoNode.GetSmsCampaigns, root.BrevoNode.PostSendSmsTestFailed, root.BrevoNode.RequestSmsRecipientExport, root.BrevoNode.SendReport, root.BrevoNode.SendTestSms, root.BrevoNode.UpdateCampaignStatus, root.BrevoNode.UpdateSmsCampaign);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} campaignId Id of the SMS campaign
     * @param {module:model/SendTestSms} phoneNumber Mobile number of the recipient with the country code. This number must belong to one of your contacts in Brevo account and must not be blacklisted
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
