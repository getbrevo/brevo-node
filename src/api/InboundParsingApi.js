...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.InboundParsingApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.ErrorModel, root.BrevoNode.GetInboundEmailEvents, root.BrevoNode.GetInboundEmailEventsByUuid);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.startDate Mandatory if endDate is used. Starting date (YYYY-MM-DD or YYYY-MM-DDTHH:mm:ss.SSSZ) from which you want to fetch the list. Maximum time period that can be selected is one month.
     * @param {String} opts.endDate Mandatory if startDate is used. Ending date (YYYY-MM-DD or YYYY-MM-DDTHH:mm:ss.SSSZ) till which you want to fetch the list. Maximum time period that can be selected is one month.
