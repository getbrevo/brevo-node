...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateSender', 'model/CreateSenderModel', 'model/ErrorModel', 'model/GetIps', 'model/GetIpsFromSender', 'model/GetSendersList', 'model/Otp', 'model/UpdateSender'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateSender'), require('../model/CreateSenderModel'), require('../model/ErrorModel'), require('../model/GetIps'), require('../model/GetIpsFromSender'), require('../model/GetSendersList'), require('../model/Otp'), require('../model/UpdateSender'));
  } else {
    // Browser globals (root is window)
    if (!root.BrevoNode) {
      root.BrevoNode = {};
    }
    root.BrevoNode.SendersApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.CreateSender, root.BrevoNode.CreateSenderModel, root.BrevoNode.ErrorModel, root.BrevoNode.GetIps, root.BrevoNode.GetIpsFromSender, root.BrevoNode.GetSendersList, root.BrevoNode.Otp, root.BrevoNode.UpdateSender);
  }
}(this, function(ApiClient, CreateSender, CreateSenderModel, ErrorModel, GetIps, GetIpsFromSender, GetSendersList, Otp, UpdateSender) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} senderId Id of the sender
     * @param {Object} opts Optional parameters
     * @param {module:model/Otp} opts.otp otp
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.validateSenderByOTPWithHttpInfo = function(senderId, opts) {
      opts = opts || {};
      var postBody = opts['otp'];

      // verify the required parameter 'senderId' is set
      if (senderId === undefined || senderId === null) {
        throw new Error("Missing the required parameter 'senderId' when calling validateSenderByOTP");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.validateSenderByOTP = function(senderId, opts) {
      return this.validateSenderByOTPWithHttpInfo(senderId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
