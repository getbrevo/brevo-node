...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.ResellerApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.AddChildDomain, root.BrevoNode.AddCredits, root.BrevoNode.CreateChild, root.BrevoNode.CreateReseller, root.BrevoNode.ErrorModel, root.BrevoNode.GetChildAccountCreationStatus, root.BrevoNode.GetChildDomains, root.BrevoNode.GetChildInfo, root.BrevoNode.GetChildrenList, root.BrevoNode.GetSsoToken, root.BrevoNode.ManageIp, root.BrevoNode.RemainingCreditModel, root.BrevoNode.RemoveCredits, root.BrevoNode.UpdateChild, root.BrevoNode.UpdateChildAccountStatus, root.BrevoNode.UpdateChildDomain);
  }
