...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BrevoNode.EmailCampaignsApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.AbTestCampaignResult, root.BrevoNode.CreateEmailCampaign, root.BrevoNode.CreateModel, root.BrevoNode.CreatedProcessId, root.BrevoNode.EmailExportRecipients, root.BrevoNode.ErrorModel, root.BrevoNode.GetEmailCampaign, root.BrevoNode.GetEmailCampaigns, root.BrevoNode.GetSharedTemplateUrl, root.BrevoNode.PostSendFailed, root.BrevoNode.SendReport, root.BrevoNode.SendTestEmail, root.BrevoNode.UpdateCampaignStatus, root.BrevoNode.UpdateEmailCampaign, root.BrevoNode.UploadImageModel, root.BrevoNode.UploadImageToGallery);
  }
