...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Body3', 'model/Body4', 'model/Body5', 'model/Deal', 'model/DealAttributes', 'model/DealsList', 'model/ErrorModel', 'model/InlineResponse201', 'model/Pipeline', 'model/Pipelines'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Body3'), require('../model/Body4'), require('../model/Body5'), require('../model/Deal'), require('../model/DealAttributes'), require('../model/DealsList'), require('../model/ErrorModel'), require('../model/InlineResponse201'), require('../model/Pipeline'), require('../model/Pipelines'));
  } else {
    // Browser globals (root is window)
    if (!root.Brevo) {
      root.Brevo = {};
    }
    root.Brevo.DealsApi = factory(root.Brevo.ApiClient, root.Brevo.Body3, root.Brevo.Body4, root.Brevo.Body5, root.Brevo.Deal, root.Brevo.DealAttributes, root.Brevo.DealsList, root.Brevo.ErrorModel, root.Brevo.InlineResponse201, root.Brevo.Pipeline, root.Brevo.Pipelines);
  }
}(this, function(ApiClient, Body3, Body4, Body5, Deal, DealAttributes, DealsList, ErrorModel, InlineResponse201, Pipeline, Pipelines) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} pipelineID Gets the pipeline details with given pipelineID and all if no pipeline provided
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Pipelines} and HTTP response
     */
    this.crmPipelineDetailsPipelineIDGetWithHttpInfo = function(pipelineID) {
      var postBody = null;

      // verify the required parameter 'pipelineID' is set
      if (pipelineID === undefined || pipelineID === null) {
        throw new Error("Missing the required parameter 'pipelineID' when calling crmPipelineDetailsPipelineIDGet");
      }
     ...
     * Get pipelines and their details
     * @param {String} pipelineID Gets the pipeline details with given pipelineID and all if no pipeline provided
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Pipelines}
     */
    this.crmPipelineDetailsPipelineIDGet = function(pipelineID) {
      return this.crmPipelineDetailsPipelineIDGetWithHttpInfo(pipelineID)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
