...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateModel', 'model/CreateWebhook', 'model/CreatedProcessId', 'model/ErrorModel', 'model/ExportWebhooksHistory', 'model/GetWebhook', 'model/GetWebhooks', 'model/UpdateWebhook'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateModel'), require('../model/CreateWebhook'), require('../model/CreatedProcessId'), require('../model/ErrorModel'), require('../model/ExportWebhooksHistory'), require('../model/GetWebhook'), require('../model/GetWebhooks'), require('../model/UpdateWebhook'));
  } else {
    // Browser globals (root is window)
    if (!root.BrevoNode) {
      root.BrevoNode = {};
    }
    root.BrevoNode.WebhooksApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.CreateModel, root.BrevoNode.CreateWebhook, root.BrevoNode.CreatedProcessId, root.BrevoNode.ErrorModel, root.BrevoNode.ExportWebhooksHistory, root.BrevoNode.GetWebhook, root.BrevoNode.GetWebhooks, root.BrevoNode.UpdateWebhook);
  }
}(this, function(ApiClient, CreateModel, CreateWebhook, CreatedProcessId, ErrorModel, ExportWebhooksHistory, GetWebhook, GetWebhooks, UpdateWebhook) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ExportWebhooksHistory} exportWebhookHistory Values to submit for webhooks history
     ...
     */
    this.exportWebhooksHistoryWithHttpInfo = function(exportWebhookHistory) {
      var postBody = exportWebhookHistory;

      // verify the required parameter 'exportWebhookHistory' is set
      if (exportWebhookHistory === undefined || exportWebhookHistory === null) {
        throw new Error("Missing the required parameter 'exportWebhookHistory' when calling exportWebhooksHistory");
      }
     ...
     */
    this.exportWebhooksHistory = function(exportWebhookHistory) {
      return this.exportWebhooksHistoryWithHttpInfo(exportWebhookHistory)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
