...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorModel', 'model/GetWhatsappEventReport', 'model/InlineResponse2012', 'model/SendWhatsappMessage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorModel'), require('../model/GetWhatsappEventReport'), require('../model/InlineResponse2012'), require('../model/SendWhatsappMessage'));
  } else {
    // Browser globals (root is window)
    if (!root.BrevoNode) {
      root.BrevoNode = {};
    }
    root.BrevoNode.TransactionalWhatsAppApi = factory(root.BrevoNode.ApiClient, root.BrevoNode.ErrorModel, root.BrevoNode.GetWhatsappEventReport, root.BrevoNode.InlineResponse2012, root.BrevoNode.SendWhatsappMessage);
  }
}(this, function(ApiClient, ErrorModel, GetWhatsappEventReport, InlineResponse2012, SendWhatsappMessage) {
  'use strict';
